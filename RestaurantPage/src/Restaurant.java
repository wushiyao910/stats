...
public class Restaurant extends JFrame {
	...
	private static int numberBusBoys;
		...
		jbRestaurant.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				if (jbRestaurant.getText().equals("Start Restaurant")) {
					...
					numberBusBoys=jcbNumTablesPerBusboy.getItemAt(jcbNumTablesPerBusboy.getSelectedIndex());
	...
	public static int getNumBusBoyNeeded()
	{
		return Restaurant.numberBusBoys;
		//return jcbNumTablesPerBusboy.getItemAt(jcbNumTablesPerBusboy.getSelectedIndex());
